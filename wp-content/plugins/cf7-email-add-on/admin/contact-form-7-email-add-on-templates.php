				...
				<div class="cf7ea-template-box">
					...
					<div class="cf7ea-template-name">
						<div class="custom-control custom-radio">
							...
							<label class="custom-control-label" for="donate_text_user"><?php _e( 'Donate Text', 'cf7-email-addon' ); ?></label>
						</div>
					</div>
				...
				<div class="cf7ea-template-box">
					...
					<div class="cf7ea-template-name">
						<div class="custom-control custom-radio">
							...
							<label class="custom-control-label" for="interview_box_user"><?php _e( 'Interview Box', 'cf7-email-addon' ); ?></label>
						</div>
					</div>
					<div class="cf7ea-template-overlay">
						<a href="javascript:;" class="selecte_template"><?php _e( 'Select Template', 'cf7-email-addon' ); ?></a>
				...
				<div class="cf7ea-template-box">
					...
					<div class="cf7ea-template-name">
						<div class="custom-control custom-radio">
							...
							<label class="custom-control-label" for="meeting_user"><?php _e( 'Meeting', 'cf7-email-addon' ); ?></label>
						</div>
					</div>
					<div class="cf7ea-template-overlay">
						<a href="javascript:;" class="selecte_template"><?php _e( 'Select Template', 'cf7-email-addon' ); ?></a>
